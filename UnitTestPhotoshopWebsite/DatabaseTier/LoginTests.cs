...
namespace PhotoshopWebsite.DatabaseTier.Tests
{
    ...
    public class LoginTests
    {
        ...
        public void loginUserTest()
        {
            ...
            dt = this.database.CallProcedure("getUserPassword", parameters);
        ...
        public void getUserIDTest()
        {
            ...
            dt = this.database.CallProcedure("getUserID", parameters);
        ...
        public void getUserDataTest()
        {
            ...
            DataTable dt = this.database.CallProcedure("getUserInformation", parameters);
            Assert.IsNotNull(dt);            
        }
    }
}