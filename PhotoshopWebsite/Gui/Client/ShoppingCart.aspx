            ...
            <div class='row'>
                ...
                <div class="well" style="background-color: #96C8FA; width: 600px; height: 100%; padding-right: 30px; padding-left: 30px;">
                    <div class="row">
                        <div class="col-md-12" style='background-color: white; border-radius: 7px; height: 50px; padding: 10px; margin-bottom: 15px;'>
                            ...
                            <asp:Label runat="server" Text="Regel uw betaling via bankoverschrijving." Style="display: inline"></asp:Label>
                        </div>
                        <div class="col-md-12" style='background-color: white; border-radius: 7px; height: 50px; padding: 10px; margin-bottom: 15px;'>
                        ...
                        <div class="col-md-12" style='background-color: white; border-radius: 7px; height: 100px; padding: 10px; margin-bottom: 15px;'>
                            ...
                            <asp:Label ID="Label1" runat="server" Text="De Meest gebruikte betaal methode van Nederland" Font-Bold="false" Style="display: inline; color: darkseagreen"></asp:Label>
                                 <div class="dropdown">
                                    <button id="dropdown" class="btn btn-default dropdown-toggle" type="button"  data-toggle="dropdown">Kies uw Bank
                ...
                <div class="row" style="background-color: #3B9BC4; width: 600px; padding-left: 5px; margin-left: 1px; border-radius: 7px;">
                    <div class="col-md-12" style="border-radius: 7px; height: 50px; padding: 10px;">
                        <button type='button' id='btnOrder' class='btn btn-primary' style="background-color:#1E8C1B" data-toggle='modal'  onclick="isReferenceNumberAvailable();" data-target='#myModal'>Bestelling plaatsen</button>
                    </div>
